  ...
  public: {
    Tables: {
      ...
      google_calendar_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "google_calendar_tokens_agente_id_fkey"
            columns: ["agente_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      tipo_interaccion:
        ...
        | "SEGUIMIENTO"
        | "CONSULTA"
      tipo_operacion: "COMPRA" | "VENTA" | "ALQUILER" | "BUSQUEDA_ALQUILER"
      tipo_propiedad:
        | "CASA"
        | "DEPARTAMENTO"
        | "PH"
